...
public class Base32 {
    ...
    public static String encode32(String dataStr) throws Exception
    {
        if (dataStr != null)
    ...
    public static String decode32(String dataStr) throws Exception
    {
        if (dataStr != null)
            return new String(decode(dataStr));
        else
            return null;
    }
