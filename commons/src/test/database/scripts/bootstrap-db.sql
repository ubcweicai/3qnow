...
CREATE SCHEMA IF NOT EXISTS `3bdbtest` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci ;
USE `3bdbtest` ;

-- -----------------------------------------------------
-- Table `3bdbtest`.`user`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `3bdbtest`.`user` ;

CREATE TABLE IF NOT EXISTS `3bdbtest`.`user` (
...
-- -----------------------------------------------------
-- Table `3bdbtest`.`category`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `3bdbtest`.`category` ;

CREATE TABLE IF NOT EXISTS `3bdbtest`.`category` (
  ...
  CONSTRAINT `category_fk_parent`
    ...
    REFERENCES `3bdbtest`.`category` (`category_id`)
    ON DELETE SET NULL
    ON UPDATE CASCADE)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `3bdbtest`.`service_status`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `3bdbtest`.`service_status` ;

CREATE TABLE IF NOT EXISTS `3bdbtest`.`service_status` (
...
-- -----------------------------------------------------
-- Table `3bdbtest`.`service_unit`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `3bdbtest`.`service_unit` ;

CREATE TABLE IF NOT EXISTS `3bdbtest`.`service_unit` (
...
-- -----------------------------------------------------
-- Table `3bdbtest`.`recommend_level`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `3bdbtest`.`recommend_level` ;

CREATE TABLE IF NOT EXISTS `3bdbtest`.`recommend_level` (
...
-- -----------------------------------------------------
-- Table `3bdbtest`.`member_type`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `3bdbtest`.`member_type` ;

CREATE TABLE IF NOT EXISTS `3bdbtest`.`member_type` (
...
-- -----------------------------------------------------
-- Table `3bdbtest`.`member`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `3bdbtest`.`member` ;

CREATE TABLE IF NOT EXISTS `3bdbtest`.`member` (
  ...
  CONSTRAINT `member_fk_user`
    FOREIGN KEY (`user_id`)
    REFERENCES `3bdbtest`.`user` (`user_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `member_fk_type`
    FOREIGN KEY (`type_code`)
    REFERENCES `3bdbtest`.`member_type` (`type_code`)
    ON DELETE SET NULL
    ON UPDATE CASCADE)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `3bdbtest`.`service_product`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `3bdbtest`.`service_product` ;

CREATE TABLE IF NOT EXISTS `3bdbtest`.`service_product` (
  ...
  CONSTRAINT `service_fk_status`
    ...
    REFERENCES `3bdbtest`.`service_status` (`status_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_service_service_unit1`
    FOREIGN KEY (`unit_id`)
    REFERENCES `3bdbtest`.`service_unit` (`unit_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_service_recommend_level1`
    FOREIGN KEY (`recommend_level_id`)
    REFERENCES `3bdbtest`.`recommend_level` (`recommend_level_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_service_member1`
    FOREIGN KEY (`member_id`)
    REFERENCES `3bdbtest`.`member` (`member_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `3bdbtest`.`service_order_status`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `3bdbtest`.`service_order_status` ;

CREATE TABLE IF NOT EXISTS `3bdbtest`.`service_order_status` (
...
-- -----------------------------------------------------
-- Table `3bdbtest`.`service_order`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `3bdbtest`.`service_order` ;

CREATE TABLE IF NOT EXISTS `3bdbtest`.`service_order` (
  ...
  CONSTRAINT `order_fk_service`
    ...
    REFERENCES `3bdbtest`.`service_product` (`service_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_order_order_status1`
    FOREIGN KEY (`status_id`)
    REFERENCES `3bdbtest`.`service_order_status` (`status_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- Table `3bdbtest`.`role`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `3bdbtest`.`role` ;

CREATE TABLE IF NOT EXISTS `3bdbtest`.`role` (
...
-- -----------------------------------------------------
-- Table `3bdbtest`.`user_role`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `3bdbtest`.`user_role` ;

CREATE TABLE IF NOT EXISTS `3bdbtest`.`user_role` (
  ...
  CONSTRAINT `role_fk`
    FOREIGN KEY (`role_id`)
    REFERENCES `3bdbtest`.`role` (`role_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `3bdbtest`.`ticket_source_type`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `3bdbtest`.`ticket_source_type` ;

CREATE TABLE IF NOT EXISTS `3bdbtest`.`ticket_source_type` (
...
-- -----------------------------------------------------
-- Table `3bdbtest`.`ticket_status`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `3bdbtest`.`ticket_status` ;

CREATE TABLE IF NOT EXISTS `3bdbtest`.`ticket_status` (
...
-- -----------------------------------------------------
-- Table `3bdbtest`.`ticket`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `3bdbtest`.`ticket` ;

CREATE TABLE IF NOT EXISTS `3bdbtest`.`ticket` (
  ...
  CONSTRAINT `ticket_fk_source`
    FOREIGN KEY (`type_code`)
    REFERENCES `3bdbtest`.`ticket_source_type` (`type_code`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_ticket_ticket_status1`
    FOREIGN KEY (`status_code`)
    REFERENCES `3bdbtest`.`ticket_status` (`status_code`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `3bdbtest`.`contact_type`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `3bdbtest`.`contact_type` ;

CREATE TABLE IF NOT EXISTS `3bdbtest`.`contact_type` (
  `type_code` VARCHAR(8) NOT NULL,
  `type_name` VARCHAR(45) NULL,
...
-- -----------------------------------------------------
-- Table `3bdbtest`.`contact`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `3bdbtest`.`contact` ;

CREATE TABLE IF NOT EXISTS `3bdbtest`.`contact` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `type_code` VARCHAR(8) NULL,
  ...
  CONSTRAINT `contact_fk_type`
    FOREIGN KEY (`type_code`)
    REFERENCES `3bdbtest`.`contact_type` (`type_code`)
    ON DELETE CASCADE
    ON UPDATE CASCADE)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `3bdbtest`.`history`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `3bdbtest`.`history` ;

CREATE TABLE IF NOT EXISTS `3bdbtest`.`history` (
  `id` INT NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `3bdbtest`.`ticket_order`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `3bdbtest`.`ticket_order` ;

CREATE TABLE IF NOT EXISTS `3bdbtest`.`ticket_order` (
  ...
  CONSTRAINT `ticket_order_fk_ticket`
    ...
    REFERENCES `3bdbtest`.`ticket` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `ticket_order_fk_order`
    FOREIGN KEY (`order_id`)
    REFERENCES `3bdbtest`.`service_order` (`order_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `3bdbtest`.`service_order_rate`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `3bdbtest`.`service_order_rate` ;

CREATE TABLE IF NOT EXISTS `3bdbtest`.`service_order_rate` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `order_id` INT NULL,
  `attitude` FLOAT NULL,
  `time` FLOAT NULL,
...
-- -----------------------------------------------------
-- Table `3bdbtest`.`media`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `3bdbtest`.`media` ;

CREATE TABLE IF NOT EXISTS `3bdbtest`.`media` (
...
-- -----------------------------------------------------
-- Table `3bdbtest`.`media_type`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `3bdbtest`.`media_type` ;

CREATE TABLE IF NOT EXISTS `3bdbtest`.`media_type` (
...
-- -----------------------------------------------------
-- Table `3bdbtest`.`country`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `3bdbtest`.`country` ;

CREATE TABLE IF NOT EXISTS `3bdbtest`.`country` (
...
-- Table `3bdbtest`.`city`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `3bdbtest`.`city` ;

CREATE TABLE IF NOT EXISTS `3bdbtest`.`city` (
  ...
  CONSTRAINT `city_fk_country`
    ...
    REFERENCES `3bdbtest`.`country` (`country_code`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `3bdbtest`.`service_area`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `3bdbtest`.`service_area` ;

CREATE TABLE IF NOT EXISTS `3bdbtest`.`service_area` (
  `service_id` INT NOT NULL,
  `city_code` VARCHAR(8) NOT NULL,
  ...
  CONSTRAINT `fk_service_area_city1`
    ...
    REFERENCES `3bdbtest`.`city` (`city_code`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `3bdbtest`.`address`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `3bdbtest`.`address` ;

CREATE TABLE IF NOT EXISTS `3bdbtest`.`address` (
...
-- -----------------------------------------------------
-- Table `3bdbtest`.`business_profile`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `3bdbtest`.`business_profile` ;

CREATE TABLE IF NOT EXISTS `3bdbtest`.`business_profile` (
  `member_id` VARCHAR(10) NOT NULL,
...
-- -----------------------------------------------------
-- Table `3bdbtest`.`business_category`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `3bdbtest`.`business_category` ;

CREATE TABLE IF NOT EXISTS `3bdbtest`.`business_category` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `member_id` VARCHAR(10) NOT NULL,
  `category_id` VARCHAR(16) NOT NULL,
  PRIMARY KEY (`id`),
  ...
  CONSTRAINT `fk_business_category_business_profile1`
    FOREIGN KEY (`member_id`)
    REFERENCES `3bdbtest`.`business_profile` (`member_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;

-- -----------------------------------------------------
-- Table `3bdbtest`.`languages`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `3bdbtest`.`languages` ;

CREATE TABLE IF NOT EXISTS `3bdbtest`.`languages` (
...
-- -----------------------------------------------------
-- Table `3bdbtest`.`recovery_token`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `3bdbtest`.`recovery_token` ;

CREATE  TABLE IF NOT EXISTS `3bdbtest`.`recovery_token` (
  `id` INT NOT NULL AUTO_INCREMENT ,
...
-- -----------------------------------------------------
-- Table `3bdbtest`.`category_tag`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `3bdbtest`.`category_tag` ;

CREATE TABLE IF NOT EXISTS `3bdbtest`.`category_tag` (
...
-- -----------------------------------------------------
-- Table `3bdbtest`.`search_missed`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `3bdbtest`.`search_missed` ;

CREATE TABLE IF NOT EXISTS `3bdbtest`.`search_missed` (
  `id` INT NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `3bdbtest`.`Ticket_Reply`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `3bdbtest`.`ticket_reply` ;

CREATE TABLE IF NOT EXISTS `3bdbtest`.`ticket_reply` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `reply_msg` TEXT NULL,
  `reply_by` INT NULL,
...
-- -----------------------------------------------------
-- Table `3bdbtest`.`history_archive`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `3bdbtest`.`history_archive` ;

CREATE TABLE IF NOT EXISTS `3bdbtest`.`history_archive` (
  `id` INT NOT NULL,
  `component_workflow_id` INT NULL,
  `workflow_state_id` INT NULL,
  `history_key` INT NULL,
...
-- -----------------------------------------------------
-- Table `3bdbtest`.`service_schedule`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `3bdbtest`.`service_schedule` ;

CREATE TABLE IF NOT EXISTS `3bdbtest`.`service_schedule` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `order_id` INT NOT NULL,
...
-- -----------------------------------------------------
-- Table `3bdbtest`.`user_profile`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `3bdbtest`.`user_profile` ;

CREATE TABLE IF NOT EXISTS `3bdbtest`.`user_profile` (
  `user_id` INT NOT NULL,
  ...
  CONSTRAINT `profile_fk_preferred_lang0`
    ...
    REFERENCES `3bdbtest`.`languages` (`language_code`)
    ON DELETE CASCADE
    ON UPDATE CASCADE,
...
-- -----------------------------------------------------
-- Table `3bdbtest`.`blog_status`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `3bdbtest`.`blog_status` ;

CREATE TABLE IF NOT EXISTS `3bdbtest`.`blog_status` (
  `status_code` VARCHAR(5) NOT NULL,
...
-- -----------------------------------------------------
-- Table `3bdbtest`.`blog_class`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `3bdbtest`.`blog_class` ;

CREATE TABLE IF NOT EXISTS `3bdbtest`.`blog_class` (
...
-- Table `3bdbtest`.`blog`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `3bdbtest`.`blog` ;

CREATE TABLE IF NOT EXISTS `3bdbtest`.`blog` (
  ...
  CONSTRAINT `fk_blog_blog_status`
    ...
    REFERENCES `3bdbtest`.`blog_status` (`status_code`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_blog_blog_class`
    FOREIGN KEY (`class_id`)
    REFERENCES `3bdbtest`.`blog_class` (`class_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;

-- -----------------------------------------------------
-- Table `3bdbtest`.`user_history`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `3bdbtest`.`user_history` (
...
-- -----------------------------------------------------
-- Table `3bdbtest`.`init_business_profile`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `3bdbtest`.`init_business_profile` ;

CREATE TABLE IF NOT EXISTS `3bdbtest`.`init_business_profile` (
  `member_id` VARCHAR(10) NOT NULL,
  `business_number` VARCHAR(45) NULL,
  `business_name` VARCHAR(255) NULL,
  `description` TEXT NULL,
...
-- Table `3bdbtest`.`business_category`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `3bdbtest`.`init_business_category` ;

CREATE TABLE IF NOT EXISTS `3bdbtest`.`init_business_category` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `member_id` VARCHAR(10) NOT NULL,
  `category_id` VARCHAR(16) NOT NULL,
  PRIMARY KEY (`id`),
  ...
  CONSTRAINT `fk_init_business_category_business_profile1`
    FOREIGN KEY (`member_id`)
    REFERENCES `3bdbtest`.`init_business_profile` (`member_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- sequence generator
--
DROP TABLE IF EXISTS `3bdbtest`.`sys_seq` ;
CREATE  TABLE IF NOT EXISTS `3bdbtest`.`sys_seq` (
...
DROP TABLE IF EXISTS `3bdbtest`.`sms_message` ;
CREATE TABLE IF NOT EXISTS `3bdbtest`.`sms_message` (
  `phone` varchar(20) NOT NULL,
