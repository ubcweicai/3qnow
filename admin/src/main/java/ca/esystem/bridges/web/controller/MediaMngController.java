...
@Controller
public class MediaMngController extends AbstractController {
    ...
    public MediaMngController(){
        
    }
        
    @RequestMapping(value = "/media/manage", method = { RequestMethod.GET, RequestMethod.POST })
