...
<body>
	<div class="container">
		...
		<div class="row">
			...
			<form:form modelAttribute="contact" method="post" action="createemailaddress.html" cssClass="form-inline" role="form">
				...
				<div class="row myrow">
					<div class="col-md-12">
						...
						<div class="row myrow">
							<div class="col-md-12">
								<form:label path="contact_value" cssClass="col-md-2 control-label">邮箱:</form:label>
								<div class="col-md-8 item-content">
