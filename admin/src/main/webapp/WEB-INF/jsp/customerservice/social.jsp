...
<body>
	<div class="container">
		...
		<div class="row">
			...
			<form:form modelAttribute="contact" method="post" action="social.html" cssClass="form-inline" role="form">
				...
				<div class="row myrow">
					<div class="col-md-12">
							...
							<div class="col-md-12">
								...
								<div class="col-md-8 item-content">
									...
									data-validation="required" data-validation-error-msg="请选择分类!">
			                  				...
			                  				<form:options items="${applicationScope.socialContactTypeMap}"/>
			                		</form:select>
			                	</div>
							</div>
						</div>						
						<div class="row myrow">
							<div class="col-md-12">
								<form:label path="contact_value" cssClass="col-md-2 control-label">帐号:</form:label>
								<div class="col-md-8 item-content">
									<form:input path="contact_value" cssClass="form-control input-sm" placeholder="Enter social account" 
									data-validation="required" data-validation-error-msg="请输入帐号!" maxlength="1024"/>
								</div>
							</div>
						</div>					
					</div>
