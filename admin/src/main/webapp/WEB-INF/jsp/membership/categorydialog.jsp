			...
			$("#addbutton").click(function(){				
				...
				if(categoryIdArray.length == 0){
					...
					for(i=0; i<categoryIdArray.length; i++){
						...
						var appendhtml1="<input id=\"businessProfile.category_list" + i + ".member_id\" name=\"businessProfile.category_list["+ i + "].member_id\" type=\"hidden\" value=\"" + member_id + "\"/>";
						var appendhtml2="<input id=\"businessProfile.category_list" + i + ".category_id\" name=\"businessProfile.category_list["+ i + "].category_id\" type=\"hidden\" value=\"" + categoryId + "\"/>";
